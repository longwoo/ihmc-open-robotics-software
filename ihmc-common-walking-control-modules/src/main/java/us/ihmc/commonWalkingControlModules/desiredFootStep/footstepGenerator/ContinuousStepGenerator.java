...
public class ContinuousStepGenerator implements Updatable
{
   ...
   private FootstepValidityChecker footstepValidityChecker;
   ...
   public void update(double time)
   {
      ...
      for (int i = startIndex; i < numberOfFootstepsToPlan.getValue(); i++)
      {
         ...
         if (footstepValidityChecker != null && !footstepValidityChecker.checkFootstep(nextFootstepPose3D))
         {
            nextFootstepPose2D.set(footstepPose2D);
    ...
    *
    * @param footstepValidityChecker method for checking step validity
    */
   public void setFootstepValidityChecker(FootstepValidityChecker footstepValidityChecker)
   {
      this.footstepValidityChecker = footstepValidityChecker;
   }
